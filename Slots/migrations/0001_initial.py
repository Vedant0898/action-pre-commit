    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Slots.location')),
            ],
        ),
        migrations.CreateModel(
            name='Slot',
            fields=[
                ...
                ('status', models.CharField(choices=[(1, 'Available'), (2, 'Booked'), (3, 'Maintenance')], max_length=1)),
                ('courts_booked', models.IntegerField(default=0)),
                ('booking', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Slots.schedule')),
            ],
        ),
    ]
