...
urlpatterns = [
    ...
    path("staff/loc/modify/<int:loc_id>",views.modify_location,name="modify_location"),
    path("staff/loc/delete/<int:loc_id>",views.delete_location,name="delete_location"),

    path("staff/scheduler/<int:loc_id>",views.scheduler,name="scheduler"),
    path("staff/scheduler/add/<int:loc_id>-<int:day>-<str:stime>",views.add_schedule,name="add_schedule"),
    path("staff/scheduler/remove/<int:loc_id>-<int:day>-<str:stime>",views.remove_schedule,name="remove_schedule"),
